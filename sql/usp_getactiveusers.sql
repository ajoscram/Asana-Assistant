...
BEGIN
	...
	ELSE IF @idproject IS NOT NULL
		...
		ON COLLABORATOR.IDcollaborator =RELPROJECTCOLLABORATOR.IDcollaborator AND RELPROJECTCOLLABORATOR.IDproject=@idproject AND RELPROJECTCOLLABORATOR.banned =0
		INNER JOIN ROL
